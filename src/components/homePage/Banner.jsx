...
const Banner = () => {
    return (
        <div className=' bg-[#F8FAFC] rounded-t-2xl'>
            <div className='container mx-auto text-center space-y-3 pt-12 pb-4'>
                ...
                <div className='grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 place-items-center mt-6 mb-6 border-b pb-8 border-gray-200'>

                    <div className='flex flex-col items-center gap-2 bg-base-100 rounded-2xl shadow-xl h-40 justify-center w-11/12 border border-gray-100 transition-all duration-300 ease-out hover:-translate-y-2 hover:shadow-2xl hover:border-gray-200'>
